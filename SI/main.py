...
=======
>>>>>>> 2c57bd60053d53450ae1157369c78c12ecf1e0f7
...
from utils.utils import convert_dict
...
def train(agent, args, train_dataset, task, all_tasks, model, task_num, tokenizer, accuracy_matrix, consolidate_fisher, consolidate_mean):
	""" Train the model """
	...
	agent.learn_batch(train_loader=train_dataloader)
...
def main():
	...
	agent_config = {'lr': 0.01,
		'momentum': 0,
		'weight_decay': 0,
		'schedule': [args.num_train_epochs],
		'optimizer': 'Adam',
		'reg_coef':0,
		'print_freq':0
	}
	...
	for i in range(len(configs)):
		...
		agent = SI(agent_config, model=models[i][1])
		...
		global_step, tr_loss, accuracy_matrix, model = train(agent,
															 new_args,
															 train_dataset,
															 tasks[i],
															 tasks,
